    ...
    <div class="regis">Регистрация</div>
            <div id="cd-signup">
				   	...
				   	<form class="cd-form" action="verification.php" method="POST">
					    ...
					    <p class="fieldset">
							<input class="full-width has-padding has-border" id="signup-username" type="text" name="user_name" placeholder="Логин" value="<?php echo $_POST['user_name']; ?>">
					    </p>
					    ...
					    <p class="fieldset">
							<input class="full-width has-padding has-border" id="signup-password" type="password" name="password" placeholder="Пароль" value="<?php echo $_POST['password']; ?>">
							<a href="#0" class="hide-password">Показать</a>
                            <span class="cd-error-message">Здесь сообщение об ошибке!</span>
					    </p>
					    
					    <p class="fieldset">
							<input class="full-width has-padding has-border" id="signup-password" type="password" name="reppass"  placeholder="Повторите пароль" value="<?php echo $_POST['reppass']; ?>">
							<a href="#0" class="hide-password">Показать</a>
							<span class="cd-error-message">Здесь сообщение об ошибке!</span>
					    </p>

					    <p class="fieldset">
                            <input class="width has-padding" name="do_signup" type="submit" value="Зарегистрироваться">
					    </p>
